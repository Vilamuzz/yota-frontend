...
import type { FosterChildrenCandidateAdminQueryParams, FosterChildrenCandidateAdminListResponse } from '@/types/fosterChildrenCandidate'
import type { ApiError } from '@/types/response'

export const useFosterChildrenCandidateList = (params: MaybeRefOrGetter<FosterChildrenCandidateAdminQueryParams>) => {
