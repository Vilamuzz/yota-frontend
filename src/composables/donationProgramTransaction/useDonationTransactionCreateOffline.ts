...
import type { CreateDonationProgramTransactionRequest, DonationProgramTransactionResponse } from '@/types/donationProgramTransaction'
...
export const useDonationTransactionCreateOffline = () => {
  ...
  >({
    mutationFn: ({ id, data }) => donationProgramTransactionService.createOfflineDonationProgramTransaction(id, data),
    onSuccess: () => {
