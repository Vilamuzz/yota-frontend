...
const buttonClasses = computed(() => {
  const base =
    'font-semibold rounded-sm transition duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center'
