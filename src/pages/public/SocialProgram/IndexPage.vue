    ...
    <div class="bg-gray-50 min-h-screen pt-28 pb-12 px-4 font-[var(--font-poppins)]">
      <div class="max-w-7xl mx-auto">
        ...
        <div class="text-center mb-8">
          <h1 class="text-3xl font-bold text-[var(--color-primary-500)] mb-3">
            PROGRAM SOSIAL
          </h1>

          <p class="text-gray-500 max-w-2xl mx-auto">
            Mari berpartisipasi dalam berbagai program sosial untuk membantu
            saudara kita yang membutuhkan. Sedekah Anda akan menjadi kebaikan
            yang terus mengalir.
          </p>
        </div>
