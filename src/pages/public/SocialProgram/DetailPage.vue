...
<div class="max-w-5xl mx-auto px-6 py-8 font-[Poppins]">
  ...
  <p class="text-xs text-gray-400 mb-8">
    *Tagihan akan muncul setiap tanggal 5
  </p>
  ...
  <div class="border-t pt-6">
    ...
    <div class="space-y-4 text-gray-600 text-sm leading-relaxed">
      ...
      <p>
        Program Santunan Rutin Anak Yatim adalah program donasi bulanan
        yang dirancang untuk memastikan anak-anak yatim binaan yayasan
        mendapatkan dukungan yang stabil dan berkelanjutan.
      </p>

      <p>
        Melalui program ini, Orang Tua Asuh dapat berkontribusi secara
        konsisten setiap bulan untuk membantu kebutuhan pendidikan,
        perlengkapan sekolah, konsumsi harian, serta pembinaan akhlak.
      </p>

      <p>
        Setiap donasi akan dikelola secara transparan dan digunakan
        untuk mendukung kebutuhan pendidikan dan kehidupan anak-anak
        yatim agar mereka tetap mendapatkan masa depan yang layak.
      </p>
