...
import { useDonationProgramMonthlyExpense } from '@/composables/donationProgramExpense/useDonationProgramMonthlyExpense'
...
const { expenseQuery, expenseItems } = useDonationProgramMonthlyExpense(donationId)
      ...
      >
        ...
        <template #rows>
          ...
          >
            ...
            <td
              class="px-6 py-2 whitespace-nowrap font-medium max-w-xs truncate text-gray-600 dark:text-gray-200"
            >
              {{ expense.title }}
            </td>
            <td
