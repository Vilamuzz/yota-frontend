...
import { createDonationProgramExpenseSchema } from '@/schemas/donationProgramExpense.schema'
import { useDonationProgramExpenseCreate } from '@/composables/donationProgramExpense/useDonationProgramExpenseCreate'
...
const { createMutation, validationErrors } = useDonationProgramExpenseCreate()
...
const handleSubmit = () => {
  const result = createDonationProgramExpenseSchema.safeParse({
...
<template>
  <DashboardLayout>
    <template #title>Tambah Pengeluaran Donasi</template>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div class="p-6 space-y-5">
            <BaseInput
              ...
              placeholder="mis. Pembelian Sembako"
              :error="titleError"
              required
            />
          ...
          <div class="p-6 space-y-5 border-l border-gray-100 dark:border-gray-700">
            ...
            >
              <p class="text-xs text-yellow-800 dark:text-yellow-400 leading-relaxed">
                ...
                langsung mempengaruhi saldo program donasi terkait.
              </p>
            </div>
          </div>
        </div>
