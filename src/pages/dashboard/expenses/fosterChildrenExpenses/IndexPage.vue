...
import { Baby, Plus, FileText } from 'lucide-vue-next'
...
const fosterChildId = router.currentRoute.value.params.id as string
...
// Fetch foster children expenses via composable
  ...
  <DashboardLayout>
    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center gap-3">
          ...
          <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400">
              Kelola dan pantau riwayat pengeluaran anak asuh.
            </p>
          </div>
        </div>
      ...
      >
        <BaseTable
          :loading="isLoading"
          loading-message="Memuat data pengeluaran anak asuh..."
          :is-empty="fosterChildrenExpenses.length === 0"
          empty-message="Tidak ada pengeluaran anak asuh yang ditemukan."
