...
const programTitle = ref(
  programData?.namaProgram || 'Santunan Rutin Anak Yatim Piatu & Dhuafa Setiap Bulan',
)
const customer = ref({
...
const billingHistory = ref([
  {
    no: 1,
    tagihan: 'Tagihan Bulan Oktober - Santunan Rutin Anak Yatim Piatu & Dhuafa',
    jumlah: 500000,
    tanggal: '10/02/2026',
    pukul: '6:55PM',
  },
  {
    no: 2,
    tagihan: 'Tagihan Bulan September - Santunan Rutin Anak Yatim Piatu & Dhuafa',
    jumlah: 500000,
    tanggal: '09/05/2026',
    pukul: '6:55PM',
  },
  {
    no: 3,
    tagihan: 'Tagihan Bulan Agustus - Santunan Rutin Anak Yatim Piatu & Dhuafa',
    jumlah: 500000,
    tanggal: '08/06/2026',
    pukul: '6:55PM',
  },
  {
    no: 4,
    tagihan: 'Tagihan Bulan Juli - Santunan Rutin Anak Yatim Piatu & Dhuafa',
    jumlah: 500000,
    tanggal: '07/05/2026',
    pukul: '6:55PM',
  },
  {
    no: 5,
    tagihan: 'Tagihan Bulan Juni - Santunan Rutin Anak Yatim Piatu & Dhuafa',
    jumlah: 500000,
    tanggal: '06/08/2026',
    pukul: '6:55PM',
  },
  {
    no: 6,
    tagihan: 'Tagihan Bulan Mei - Santunan Rutin Anak Yatim Piatu & Dhuafa',
    jumlah: 500000,
    tanggal: '05/09/2026',
    pukul: '6:55PM',
  },
  {
    no: 7,
    tagihan: 'Tagihan Bulan April - Santunan Rutin Anak Yatim Piatu & Dhuafa',
    jumlah: 500000,
    tanggal: '04/12/2026',
    pukul: '6:55PM',
  },
  {
    no: 8,
    tagihan: 'Tagihan Bulan Maret - Santunan Rutin Anak Yatim Piatu & Dhuafa',
    jumlah: 500000,
    tanggal: '03/10/2026',
    pukul: '6:55PM',
  },
  {
    no: 9,
    tagihan: 'Tagihan Bulan Februari - Santunan Rutin Anak Yatim Piatu & Dhuafa',
    jumlah: 500000,
    tanggal: '02/5/2026',
    pukul: '6:55PM',
  },
  {
    no: 10,
    tagihan: 'Tagihan Bulan Januari - Santunan Rutin Anak Yatim Piatu & Dhuafa',
    jumlah: 500000,
    tanggal: '01/12/2026',
    pukul: '6:55PM',
  },
...
<template>
  <DashboardLayout>
    ...
    <div class="mt-6">
      <div
        class="bg-white rounded-xl border border-gray-200 px-6 py-4 mb-5 flex items-center gap-4 shadow-sm"
      >
        <!-- BACK BUTTON -->
      ...
      <div class="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
        ...
        <div class="overflow-x-auto">
          ...
          >
            <template #headers>
              <th
                class="px-4 py-4 text-left text-xs font-semibold text-gray-400 uppercase tracking-wider"
              >
                No
              </th>
              <th
