...
const program = route.query.subscription ? JSON.parse(route.query.subscription as string) : null
...
<template>
  <DashboardLayout>
    ...
    <div class="mt-6">
      <!-- HEADER -->
      <div
        class="bg-white rounded-xl border border-gray-200 px-6 py-4 mb-5 flex items-center gap-4"
      >
      ...
      <div class="bg-white rounded-xl border border-gray-200 p-5">
        ...
        <div class="flex items-center justify-between mb-5">
          <h2 class="text-base font-semibold text-gray-700">Data Subscriber Program</h2>
          ...
          <div class="flex items-center gap-2">
            ...
            <!-- EXPORT PDF -->
            <BaseButton variant="primary"> Export PDF </BaseButton>
          </div>
        </div>
