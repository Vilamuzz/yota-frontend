...
import { useDonationTransactionCreateOffline } from '@/composables/donationTransaction/useDonationTransactionCreateOffline'
...
const { createMutation, createError } = useDonationTransactionCreateOffline()
