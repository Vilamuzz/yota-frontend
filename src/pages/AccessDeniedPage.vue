    ...
    <div class="max-w-md w-full text-center">
      ...
      <div class="relative mb-12 flex justify-center">
        <div class="relative">
          <!-- Background Glow -->
          <div
            class="absolute -inset-4 bg-danger-500/10 dark:bg-danger-500/5 rounded-full blur-2xl animate-pulse"
          ></div>
          ...
          >
            <ShieldAlert
              :size="64"
              class="text-danger-500 group-hover:scale-110 transition-transform duration-500"
            />

            <!-- Corner Accent -->
            <div
              class="absolute -top-2 -right-2 w-8 h-8 bg-danger-500 rounded-xl flex items-center justify-center shadow-lg transform rotate-12"
            >
      ...
      <div class="space-y-4 mb-10">
        <div
          class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-danger-50 dark:bg-danger-500/10 text-danger-600 dark:text-danger-400 text-xs font-bold uppercase tracking-wider mb-2"
        >
          Error 403
        </div>
        ...
        <p class="text-gray-500 dark:text-gray-400 leading-relaxed max-w-sm mx-auto">
          Maaf, akun Anda tidak memiliki izin yang diperlukan untuk mengakses halaman ini. Ini
          adalah area terbatas untuk peran tertentu.
        </p>
      </div>
      ...
      <p class="mt-12 text-gray-400 dark:text-gray-600 text-xs">
        Butuh bantuan? Hubungi tim administrator kami.
      </p>
    </div>
  </div>
</template>
